...
class MvvmCounterAuthWidget extends StatelessWidget {
  const MvvmCounterAuthWidget({super.key});

  static Widget create() {
    return ChangeNotifierProvider(
        create: (_) => MvvmCounterAuthViewModel(),
        child: const MvvmCounterAuthWidget());
  }
